...
class PromptView:
    def __init__(self, parent, main_root):
        self.parent = parent
        self.main_root = main_root # Referencia a la ventana principal para poder volver
    ...
    def show_result_view(self):
        ...
        # Genera el contenido markdown al momento, directamente desde el estado en memoria.
        print("DEBUG: Generating markdown from in-memory AppState...")
        ...
        # Cierra la ventana actual y abre la de resultados
        self.parent.destroy()
